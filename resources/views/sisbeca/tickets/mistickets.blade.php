...
@section('title','Mis tickets: '.$usuario->nombreyapellido())
@section('content')
<div class="col-lg-12" id="app">
	<div class="text-right">
        <a href="{{route('ticket.crear')}}" class="btn btn-sm sisbeca-btn-primary">Crear Ticket</a>
    </div>
    <hr>
