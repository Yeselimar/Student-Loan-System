...
<div class="col-lg-12" id="app">
	...
	<br>
	<table class="table table-hover table-bordered" id="voluntariadox">
            <thead>
                <tr>
                    <th>Cédula</th>
                    <th>Nombre</th>
            ...
            <tbody>
                <tr v-for="(voluntariado,index) in voluntariados" :key="index">
                    <td>@{{voluntariado.id}}</td>
                    <td>@{{ voluntariado.usuario.name }} @{{ voluntariado.usuario.last_name }}</td>
                    <td>a</td>
                    <td>aaaa</td>
                    <td>aaa</td>
                    <td>
