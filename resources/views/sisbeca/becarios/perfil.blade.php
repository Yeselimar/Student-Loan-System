            ...
            <div class="card-two">
				<div class="text-right col-12" align="right">
					...
					@if($becario->status==='activo')
						<span class="label label-success"><strong>Activo</strong></span>
					@else
						@if($becario->status==='probatorio1')
							<span class="label label-warning"><strong>En Probatorio 1</strong></span>
						@else
							@if($becario->status==='probatorio2')
								<span class="label label-danger"><strong>En Probatorio 2</strong></span>
							@else
								<span class="label label-info"><strong>{{ucwords($becario->status)}}</strong></span>
							@endif
						@endif
					@endif
                    -->
                ...
                <h3>{{$becario->user->name}} {{$becario->user->last_name }}</h3>
                <div class="desc">
                ...
                <div class="desc">
                    @if($becario->user->rol=='becario')
                        <span class="label label-info">Becario</span>
                    @else
                        <span class="label label-warning">Postulante Becario</span>
                    @endif
                </div>
				...
				<div class="text-center">
					...
					@else
						<span class=" fa fa-calendar"></span>
                        {{$becario->user->edad}} Años &nbsp;&nbsp;&nbsp;
					@endif

					<span class="fa fa-birthday-cake"></span>
                    {{ date("d/m/Y", strtotime($becario->user->fecha_nacimiento)) }}
        ...
        <div class="col-lg-12" style="border:1px solid #eee">
            <div class="row">
                <div class="col-md-3 col-xs-6 b-r"> <strong>Nombre Completo</strong>
                    <br>
                    <p class="text-muted">{{$becario->user->nombreyapellido()}}</p>
                </div>
