		...
		<div class="panel-body">
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						...
						{{ Form::text('inicio_universidad',  date("d/m/Y"), ['class' => 'form-control','placeholder'=>'15/10/2012','id'=>"datepicker"])}}
						@else
						{{ Form::text('inicio_universidad',  date("d/m/Y", strtotime($becario->inicio_universidad)), ['class' => 'form-control','placeholder'=>'15/10/2012','id'=>"datepicker"])}}
						@endif
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('nombre_universidad', null, ['class' => 'form-control','placeholder'=>'EJ: Universidad de Carabobo.'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('carrera_universidad', null, ['class' => 'form-control','placeholder'=>'EJ: Lic. Computación'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('costo_matricula', null, ['class' => 'form-control','placeholder'=>'EJ: 2500.00'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('promedio_universidad', null, ['class' => 'form-control','placeholder'=>'EJ: 17.5'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('periodo_academico', null, ['class' => 'form-control','placeholder'=>'EJ: 2-2017'])}}
