		...
		<div class="panel-body">
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('nombre_institucion', null, ['class' => 'form-control','placeholder'=>'EJ: U.E. José Austria'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('direccion_institucion', null, ['class' => 'form-control','placeholder'=>'EJ: La Isabelica, Valencia.'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('director_institucion', null, ['class' => 'form-control','placeholder'=>'EJ: Pedro Pérez'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('bachiller_en', null, ['class' => 'form-control','placeholder'=>'EJ: Ciencias'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('promedio_bachillerato', null, ['class' => 'form-control','placeholder'=>'EJ: 17.5'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('actividades_extracurriculares', null, ['class' => 'form-control','placeholder'=>'EJ: Deporte, Danza, etc.'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('lugar_labor_social', null, ['class' => 'form-control', 'placeholder'=>'EJ: Cancha El Remanso'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('direccion_labor_social', null, ['class' => 'form-control', 'placeholder'=>'EJ: San Diego, Edo. Carabobo.'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('supervisor_labor_social', null, ['class' => 'form-control', 'placeholder'=>'EJ: Josefina Pérez'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('aprendio_labor_social', null, ['class' => 'form-control', 'placeholder'=>'EJ: Aprendí a...'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						<select class="form-control" name="habla_otro_idioma" id="hablaidioma">
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						{{ Form::text('habla_idioma', null, ['class' => 'form-control', 'placeholder'=>'EJ: Inglés','id'=>'h1'])}}
			...
			<div class="form-group">
				<div class="row" >
					...
					<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
						<select class="form-control" name="nivel_idioma" id="h2">
