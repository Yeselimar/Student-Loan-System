...
<ul style="list-style: none;color:#003865">
	...
	<li></li>
	<li>
		Hola <strong>{{$becario->user->nombreyapellido()}}</strong> nuestro equipo le complace invitarlo para el <strong>acto de bienvenida</strong> de nuestros becarios a <strong>Pro-Excelencia</strong>.
	</li>
	<li><br></li>
