...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_select__ = __webpack_require__(216);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_relacionBecarioMentorComponent_vue__ = __webpack_require__(217);
...
var update = __webpack_require__(16)("ede093c4", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getDataTable: function getDataTable() {
      ...
      axios.get(this.relacionBecarioMentor).then(function (response) {
        _this.llenarSelects();
    ...
    llenarSelects: function llenarSelects() {
      ...
      axios.get(this.getMentores).then(function (response) {
        var auxMentores = [];
      ...
      axios.get(this.getBecarios).then(function (response) {
        var auxBecarios = [];
                            ...
                            _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    $event.stopPropagation()
                                    return _vm.cancel(row.index, row)
                                  }
                                }
                              },
                            ...
                            _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    $event.stopPropagation()
                                    return _vm.edit(row.index, row, $event)
                                  }
                                }
                              },
