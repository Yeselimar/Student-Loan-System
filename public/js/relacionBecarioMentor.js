...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_select__ = __webpack_require__(188);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_relacionBecarioMentorComponent_vue__ = __webpack_require__(189);
...
var update = __webpack_require__(192)("ede093c4", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    edit: function edit(index, row, e) {
      console.log('event ', e);
      console.log('row ', row);
    ...
    save: function save(index, row) {
      ...
      if (this.selected.id !== row.item.mentor.id) {
        ...
        axios.post(url, dataform).then(function (response) {
          ...
          row.item.mentor = _this2.selected;
          if (_this2.selected.id == null) {
    ...
    llenarSelects: function llenarSelects() {
      ...
      axios.get("http://localhost:8000/sisbeca/getMentoresApi").then(function (response) {
        ...
        console.log("mentores ", _this3.mentores);
      }).catch(function (err) {
        console.error("error reject", err);
        return err;
      });
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            "b-col",
            { staticClass: "my-1 text-right", attrs: { md: "4" } },
            [
              _c(
                "b-form-group",
                {
      ...
      _vm._v(" "),
      _c("b-table", {
        staticClass: "table table-hover datatable",
        attrs: {
          "show-empty": "",
